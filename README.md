# IPSW Updater (iCosiSenpai Fork)
*Forked and modified by iCosiSenpai. Originally made by [Pico Mitchell](https://randomapplications.com) of [Free Geek](https://www.freegeek.org) using the [IPSW Downloads API](https://ipsw.me) by [Callum Jones](https://ipsw.me/about).*

### Changelog (iCosiSenpai Fork)
